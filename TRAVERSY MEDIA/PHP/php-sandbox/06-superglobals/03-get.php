...
$validLocations = array_map('strtolower', array_unique(array_column($listings, 'location')));
...
if (in_array($location, $validLocations)) {
  $listings = array_filter($listings, fn($job) => strcasecmp($job['location'], $location) === 0);
}
